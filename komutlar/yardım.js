...
const yardım = new Discord.MessageEmbed()
  .setAuthor(`Feârless Yardım Menüsü`, client.user.avatarURL())
  .setColor("green")
  .setThumbnail(client.user.avatarURL())
  .setDescription("Bu Bot Furkan Yılmaz Tarafından Kodlanmış & Geliştirilmiştir.")
  ...
  .addField(" • Linkler:", "• [İnstagram](https://www.instagram.com/iamfearlessxd/")
  .setImage("")
.setFooter("Feârless", message.author.avatarURL())
.setTimestamp()
